/* This program is for monitoring humidity and temperature using DHT11 sensor ande for uplolading thge same values on Thinspeak.com as tutorial of IoT. */
...
#define DHTPIN 4        // Connect the signal pin of DHT11 sensor to digital pin 4
#define DHTTYPE DHT11 
DHT dht(DHTPIN, DHTTYPE);
String apiKey = "OZ1LVLW1HF30000J";     // replace with your channel's thingspeak WRITE API key
String ssid="Armour";                   // Wifi network SSID
String password ="sagargodase";         // Wifi network password
boolean DEBUG=true;
        ...
        if (DEBUG) Serial.println("Failed to read from DHT");
          ...
          if (DEBUG) Serial.println("Humidity="+String(h)+" %");
           thingSpeakWrite(t,h);                                      // Write values to thingspeak
                                                                      ...
                                                                      // thingspeak takes 15 sec delay between updates,     
  delay(20000);  
}
